...
var paths = {
	...
	vendorJsLibs: {
		...
		dev: [
            ...
            { path: './node_modules/@uirouter/angular/_bundles/ui-router-ng2.js', singleFile: true, dest: '@uirouter/angular/_bundles' },
            { path: './node_modules/@uirouter/core/_bundles/ui-router-core.js', singleFile: true, dest: '@uirouter/core/_bundles' },
            { path: './node_modules/@uirouter/rx/_bundles/ui-router-rx.js', singleFile: true, dest: '@uirouter/rx/_bundles' },
            { path: './node_modules/@uirouter/sticky-states/_bundles/ui-router-sticky-states.js', singleFile: true, dest: '@uirouter/sticky-states/_bundles' }
		],
		prod: [
